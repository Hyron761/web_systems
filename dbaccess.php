<?php
$dsn = 'mysql:host=rds-kyou-db.crqmemsomjjy.ap-northeast-1.rds.amazonaws.com;dbname=db_kyou_services';
$username = 'svc_user';
$password = 'kyotenso3267';
...
<?php foreach ($rec as $a):?>
        <?=escape1($a)?><br>
<?php endforeach; ?>
Add comment by Kyou Add comment by Kyou at 2.
</body>
</html>
